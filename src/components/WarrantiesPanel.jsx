  ...
  const loadGarantias = async () => {
    ...
    //  Validación especial: producto debe existir en la sucursal
    if (!formData.producto || formData.producto === "") {
      newErrors.producto = "Producto no esta en la sucursal o esta vacio.";
    }

    //  Validaciones generales
    if (!formData.fecha_inicio_garantia) newErrors.fecha_inicio_garantia = "La fecha de inicio es obligatoria.";
    if (!formData.fecha_fin_garantia) newErrors.fecha_fin_garantia = "La fecha de fin es obligatoria.";
    ...
    if (!formData.telefono_cliente.trim()) newErrors.telefono_cliente = "El teléfono es obligatorio.";
          ...
          <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
            <div className="bg-white rounded-lg shadow-lg w-96 p-6 relative max-h-[90vh] overflow-y-auto">
              ...
              <div className="flex flex-col gap-3">
                ...
                <input
                  type="text"
                  placeholder="Buscar por nombre, serial o cliente"
                  disabled={editing}
